<template>
  <div class="presenter-view">
    <div class="toolbar">
      ...
      >
        <IconStopwatchStart class="tool-icon" />
        <span>计时器</span>
      </div>
      <div
        class="tool-btn"
        @click="() => (fullscreenState ? manualExitFullscreen() : enterFullscreen())"
      >
    ...
    <div class="remark">
      ...
      <div class="remark-scale">
        <div
          :class="['scale-btn', { disable: remarkFontSize === 12 }]"
          @click="setRemarkFontSize(remarkFontSize - 2)"
        >
          <IconMinus />
        </div>
        <div
          :class="['scale-btn', { disable: remarkFontSize === 40 }]"
          @click="setRemarkFontSize(remarkFontSize + 2)"
        >
          <IconPlus />
        </div>

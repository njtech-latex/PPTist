    ...
    <div class="content">
      <div class="style" v-if="activeTab === 'style'">
        ...
        <ButtonGroup class="row">
          ...
          <Button style="flex: 1" @click="emitRichTextCommand('fontsize-reduce')">
            <IconFontSize />
            -
          </Button>
        </ButtonGroup>

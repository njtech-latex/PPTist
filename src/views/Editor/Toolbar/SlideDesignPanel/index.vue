  ...
  <div class="slide-design-panel">
    ...
    <div class="row">
      ...
      <Select
        ...
        @update:value="
          (value) => updateImageBackground({ size: value as SlideBackgroundImageSize })
        "
    ...
    <template v-if="moreThemeConfigsVisible">
      ...
      <div class="row" style="height: 30px">
        ...
        <Slider
          ...
          @update:value="
            (value) => updateTheme({ shadow: { ...theme.shadow, h: value as number } })
          "
        />
      </div>
      <div class="row" style="height: 30px">
        ...
        <Slider
          ...
          @update:value="
            (value) => updateTheme({ shadow: { ...theme.shadow, v: value as number } })
          "
        />
      </div>
      <div class="row" style="height: 30px">
        ...
        <Slider
          ...
          @update:value="
            (value) => updateTheme({ shadow: { ...theme.shadow, blur: value as number } })
          "
        />
      </div>
      <div class="row">
